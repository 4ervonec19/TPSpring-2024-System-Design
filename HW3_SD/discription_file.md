...
Система лотерей - система, которая будет выдавать пользователю/-ям сгенерированную случайную игру в результате оплаты или на основе имеющихся игр. Этот продукт будет выбран для игры или добавления в библиотеку.
...
* ***Мкксимальное количество пользователей при одном сеансе*** : <br>
